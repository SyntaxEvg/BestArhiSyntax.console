...
namespace WatchDog.src
{
    internal class WatchDog
    {
        ...
        public async Task InvokeAsync(HttpContext context)
        {
            ...
            var contextP =context.Request.Path.ToString();
            if (!contextP.Contains("WTCHDwatchpage")  
                && !contextP.Contains("swagger")  
                && !contextP.Contains("watchdog") 
                && !contextP.Contains("WTCHDGstatics") 
                && !contextP.Contains("favicon") 
                && !contextP.Contains("wtchdlogger") 
